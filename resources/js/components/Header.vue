      ...
      <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
        ...
        <div class="flex items-center lg:order-2">
          ...
          <button  type="button"
            ...
            <svg v-if="showMenuMobile.value === false" class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
              <path fill-rule="evenodd"
                d="M3 5a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 10a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 15a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z"
                clip-rule="evenodd"></path>
            </svg>
            <svg v-if="showMenuMobile.value === true" class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
              <path fill-rule="evenodd"
        ...
        <div :class="`${showMenuMobile.value === true ? 'block': 'hidden'} justify-between items-center w-full lg:flex lg:w-auto lg:order-1`" id="mobile-menu-2">
